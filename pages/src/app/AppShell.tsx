  ...
  return (
    <Layout className="app-layout">
      <Header className="app-header">
        <a href="https://github.com/HLND2T/GoldSrc_VibeSignatures" target="_blank" rel="noopener noreferrer" className="app-brand">
          <DashboardOutlined />
          <Typography.Text strong>GoldSrc VibeSignatures</Typography.Text>
        </a>
        <Tabs
          className="app-nav"
          activeKey={activeTab}
