...
const LANGUAGE_STORAGE_KEY = 'gsvibe.language'
  ...
  en: {
    translation: {
      ...
      symbols: {
        ...
        kinds: { scalar: 'Scalar', function: 'Function', virtualFunction: 'Virtual Function', global: 'Global Variable', vtable: 'VTable', structMember: 'Struct Member', patch: 'Patch', unknown: 'Unknown' },
      },
    },
  },
  'zh-CN': {
    translation: {
      ...
      symbols: {
        ...
        kinds: { scalar: '标量', function: '函数', virtualFunction: '虚函数', global: '全局变量', vtable: '虚表', structMember: '结构体成员', patch: '补丁', unknown: '未知' },
      },
    },
  },
  'zh-TW': {
    translation: {
      ...
      symbols: {
        ...
        kinds: { scalar: '純量', function: '函式', virtualFunction: '虛擬函式', global: '全域變數', vtable: '虛擬表', structMember: '結構成員', patch: '修補', unknown: '未知' },
      },
    },
  },
} as const
