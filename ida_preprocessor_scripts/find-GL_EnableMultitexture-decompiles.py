#!/usr/bin/env python3
"""Recover mtexenabled from the verified standalone enable helper.

The target is the state written to one after selecting texture unit 1 and
enabling GL_TEXTURE_2D, not the capability flag checked on entry."""

from ida_analyze_util import preprocess_common_skill

TARGET_NAMES = ["mtexenabled"]
PREDECESSOR = "GL_EnableMultitexture"
LLM_DECOMPILE = [
    {
        "symbol_name": name,
