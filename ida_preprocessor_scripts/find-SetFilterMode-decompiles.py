#!/usr/bin/env python3
"""Recover filterMode from the verified SetFilterMode argument stores.
...
LLM_DECOMPILE = [
    {
        ...
        "reference_yaml_paths": ["references/{gamever}/engine/SetFilterMode.{platform}.yaml"],
        "expected_result_sections": ["found_gv"],
        "dependency_policy": {"SetFilterMode.{platform}.yaml": "required"},
    }
