#!/usr/bin/env python3
"""Recover filterColorRed, filterColorGreen, filterColorBlue from the verified SetFilterColor_I argument stores.
...
LLM_DECOMPILE = [
    {
        ...
        "reference_yaml_paths": ["references/{gamever}/engine/SetFilterColor_I.{platform}.yaml"],
        "expected_result_sections": ["found_gv"],
        "dependency_policy": {"SetFilterColor_I.{platform}.yaml": "required"},
    }
