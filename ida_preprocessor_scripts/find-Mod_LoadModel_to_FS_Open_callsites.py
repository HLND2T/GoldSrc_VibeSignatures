#!/usr/bin/env python3
"""Locate Mod_LoadModel CALL/JMP sites that target FS_Open.

ResourceReplacer redirects those branches to Mod_LoadModel_FS_Open instead of
hooking FS_Open globally. Each qualifying instruction is a separate patch
artifact:

    Mod_LoadModel_to_FS_Open_callsite_0
    Mod_LoadModel_to_FS_Open_callsite_1
    ...

Numbering is the Mod_LoadModel-body instruction address order, starting at 0.
