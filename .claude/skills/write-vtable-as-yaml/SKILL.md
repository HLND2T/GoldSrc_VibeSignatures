...
description: Write vtable analysis results as YAML file beside the binary using IDA Pro MCP. Use this skill after locating a vtable to persist the results in a standardized YAML format. GoldSrc x86 only: 4-byte vtable slots, Linux Itanium ABI skips 8 bytes of metadata.
---

# Write VTable as YAML (GoldSrc)

Persist vtable analysis results to a YAML file beside the binary using IDA Pro MCP. Applies to GoldSrc **PE32/I386** (Windows) and **ELF32/I386** (Linux) binaries only.
