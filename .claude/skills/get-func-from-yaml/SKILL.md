...
- `func_name`: The function name to look up (e.g., `R_RenderView`, `CBasePlayer_AddPoints`, `CHud_Redraw`)
...
func_rva: 0x244610
func_size: 0x4DB
func_sig: 55 8B EC F3 0F 10 05 ?? ?? ?? ?? 83 EC 14
```
...
|-------|-------------|---------|
| `func_name` | Function name | `R_RenderView` |
| `func_va` | Virtual address of function (optional in some virtual-function YAML) | `0x10244610` |
| `func_rva` | Relative virtual address (optional) | `0x244610` |
| `func_size` | Function size in bytes (optional) | `0x4DB` |
| `func_sig` | Byte signature (optional) | `55 8B EC F3 0F 10 05 ?? ?? ?? ?? 83 EC 14` |
| `vtable_name` | Related class name for virtual function (optional) | `CBasePlayer` |
| `vfunc_offset` | Offset from vtable start (optional) | `0x330` |
| `vfunc_index` | Index in vtable (optional) | `204` |
